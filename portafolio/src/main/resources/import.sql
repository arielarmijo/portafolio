...
insert into proyectos (id, nombre, descripcion_corta, url_proyecto, url_repositorio, creado_en, imagen) values (1, 'World Parts', 'Certificacion Talento Digital', 'http://monkeycode.tk/worldparts', 'https://github.com/arielarmijo/certificacion-td', to_date('2021-01-27', 'yyyy-MM-dd'), 'camaleon.jpg');
